...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/TIznuhV.png" alt="" id="produtoImg">
            </div>

            <div class="col-2">
                <h1>Relógio Feminino</h1>
                <h4>R$ 20,00 </h4>
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Relógio de Ponteiro Feminino',20.00)">Adicionar ao
                        Carrinho</button>
                ...
                <p>Relógio de Ponteiro Feminino</p>
            </div>
